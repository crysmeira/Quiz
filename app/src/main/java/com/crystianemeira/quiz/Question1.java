...
import static com.crystianemeira.quiz.R.layout.question;
...
public class Question1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.add(R.string.harvard);
        options.add(R.string.stanford);
        options.add(R.string.yale);
        options.add(R.string.berkeley);
        options.add(R.string.princeton);
